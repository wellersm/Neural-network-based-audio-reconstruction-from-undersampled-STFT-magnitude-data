...
for epoch in range(50):
    ...
    if epoch == 0 or test_loss[epoch] < opt_loss:
        ...
        torch.save(model, f"Results32000/model_phaseI.pt")
...
plt.legend()
plt.grid(True)
fig.savefig(f"Results32000/plt_loss_phaseI.png", bbox_inches="tight")
# ---------- ---------- ----------


# ----------- Training - Phase II ----------
# Load model and decrease learning rate
model = torch.load("Results32000/model_phaseI.pt")
...
torch.save(model, "Results32000/model_phaseII.pt")
epochs_phaseII = 0
...
for epoch in range(int(epochs_phaseI//2+1)):
    ...
    if test_loss[epoch] < opt_loss:
        ...
        torch.save(model, f"Results32000/model_phaseII.pt")
...
plt.legend()
plt.grid(True)
fig.savefig(f"Results32000/plt_loss_phaseII.png", bbox_inches="tight")
# ---------- ---------- ----------
...
for epoch in range(num_epochs):
    ...
    if test_loss[epoch] < opt_loss:
        ...
        torch.save(model, f"Results32000/final.pt")
        start_timeII = time.time()

    else:

        model = torch.load("Results32000/final.pt")
        start_timeII = time.time()
...
plt.legend()
plt.grid(True)
fig.savefig(f"Results32000/plt_loss_phaseIII.png", bbox_inches="tight")
# ---------- ---------- ----------
...
plt.legend()
plt.grid(True)
fig.savefig(f"Results32000/plt_loss.png", bbox_inches="tight")
...
with torch.no_grad():
    ...
    fig.savefig(f"Results32000/rec.png", bbox_inches="tight")
    ...
    fig.savefig(f"Results32000/meas.png", bbox_inches="tight")